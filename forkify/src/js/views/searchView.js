...
acc: 15 / acc + cur.length = 18 / newTitle=['Paste', 'with', 'tomato']
acc: 18 / acc + cur.length = 24 / newTitle=['Paste', 'with', 'tomato']
*/
...
const renderButtons = (page, numResults, resPerPage) => {
  const pages = Math.ceil(numResults / resPerPage); // round up 4.5 to 5
  let button;
